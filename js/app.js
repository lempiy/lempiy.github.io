...
var pokedexView = {
		...
		/*  Init function declares basic variables. Renders 'press-card' dialog with user */
		init: function () {
		...
		/*  Main method for pokedex rendering. Takes an pokemon object as argument (from event listner), 
			...
			creates a specific table row. At the last function creates Jquary animation that focuses user scroll
			bar on pokedex element. It allows user to deal with a very long lists */
		render: function (obj) {
